...
class OpenDepositAccountResponseDict(TypedDict):
    """
    Структура данных для ответа открытия депозитного счета.
    """
    account: AccountDict
...
class OpenSavingsAccountResponseDict(TypedDict):
    """
    Структура данных для ответа открытия сберегательного счета.
    """
    account: AccountDict
...
class OpenDebitCardAccountResponseDict(TypedDict):
    """
    Структура данных для ответа открытия дебетового счета.
    """
    account: AccountDict
...
class OpenCreditCardAccountResponseDict(TypedDict):
    """
    Структура данных для ответа открытия кредитного счета.
    """
    account: AccountDict
